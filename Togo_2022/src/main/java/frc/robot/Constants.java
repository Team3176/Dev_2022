...
public class Constants {
  ...
  public static final double[][] controllerChoices = { {0, 0,   0.10, 1.0, 0.7, 6.0}, // joystick general
                                                        {1, 1,  0.05, 1.0, 0.7, 6.0}, // Xbox general
                                                        {2, 0,  0.10, 2.0, 0.7, 6.0}, // joystick scaled up (L2 & R4)
                                                        {3, 1,  0.10, 2.0, 0.7, 6.0} }; // Xbox X3
